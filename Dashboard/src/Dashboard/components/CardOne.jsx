const CardOne = () => {
  return (
    <div className="rounded-sm border border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark flex-col flex justify-center text-center">
      <div className="flex h-11.5 w-11.5 items-center justify-center rounded-full bg-meta-2 dark:bg-meta-4 m-auto">
        <svg
      ...
      <div className="mt-4 flex items-end justify-center">
        <div>
          ...
          <span className="text-sm font-medium">عدد المشاهدات</span>
        </div>
      </div>
    </div>
  );
