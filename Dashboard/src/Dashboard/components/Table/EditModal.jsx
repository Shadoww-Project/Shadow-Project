...
export default function EditModal({ handleModal, setIsEdit, isEdit }) {
  return (
    <>
      {/* Edit User Modal */}
      <div
        className={`fixed left-0 top-0 md:left-[300px] md:top-37 right-0 z-50 mt-10 items-center justify-center pt-[450px] py-20 sm:p-10 ${
          isEdit ? "flex" : "hidden "
        } overflow-x-hidden overflow-y-auto  h-modal`}
        id="edit-user-modal"
      >
          ...
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-800">
            ...
            <div className="flex items-start justify-between p-5 border-b rounded-t dark:border-gray-700">
              <h3 className="text-xl font-semibold dark:text-white">
                <button
                  onClick={() => handleModal(setIsEdit, false)}
                  type="button"
