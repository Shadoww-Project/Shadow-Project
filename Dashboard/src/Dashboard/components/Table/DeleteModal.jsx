...
export default function DeleteModal({ handleModal, setIsDelete, isDelete }) {
  return (
    <>
      {/* Delete User Modal */}
      <div
        className={`fixed left-0 top-0 md:left-[300px] md:top-37 right-0 z-50 mt-10 items-center justify-center py-20 sm:p-10 ${
        ...
        <div className="relative w-full h-full max-w-md px-4 md:h-auto">
          ...
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-800">
            ...
            <div className="flex justify-end p-2">
              <button
                onClick={() => handleModal(setIsDelete, false)}
                type="button"
