  ...
  return (
    <div className="rounded-sm border border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark text-center flex-col flex">
      <div className="flex h-11.5 w-11.5 items-center justify-center rounded-full bg-meta-2 dark:bg-meta-4 m-auto">
        <svg className="fill-primary" height="20" width="20" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink"
      ...
      <div className="mt-4 flex items-end justify-center">
        <div>
          ...
          <span className="text-sm font-medium">Total Cities</span>
        </div>
      </div>
    </div>
  );
